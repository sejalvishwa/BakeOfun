    ...
    <>
            ...
            <div class="col-12 text-center">
              <div class="about-content mx-auto">
                ...
                <h2 class="about-subtitle">
                  We are Arna Bakers Private Limited
                </h2>

                <p class="about-text">
                  Our Food-Business Family's commitment in crafting Quality
                  Baked Food & Confectionary products spans over five decades
                  (since 1960).
                </p>

                <p class="about-text">
                  We are into Manufacturing, distribution & retail of premium
                  baked food products viz. Cookies, Rusks, Breads, Cakes,
                  Muffins, Puffs, Pastries etc. under our flagship brand-
                  'BAKEOFUN'.
                </p>

                <p class="about-text">
                  Our products offerings include more than 150 SKUs which are
                  regularly crafted in our state-of-the-art industrial unit.
                </p>

                <p class="about-text">
                  We have been the Contract Manufacturers of 'Parle-G' biscuits
                  for Parle Biscuits Pvt. Ltd. in Raipur & U.P; the CM Unit of
                  'Parle' in Raipur was set up by us in the year 2011 which
                  happens to be the largest Automatic Biscuit Plant of
                  Chhattisgarh.
                </p>
              </div>
            </div>
      ...
      <div className="container-fluid the-brand">
        <div
          ...
          style={{ backgroundColor: "#BC83661A", paddingBottom: "50px" }}
        >
          ...
          <div className="col-md-6">
            <div className="about-logo-section">
              <div className="about-logo-right">
                <h2>The Brand: BakeOFun</h2>
              </div>
              <div className="trusted-para">
                <p>
                  We are a Trusted International Quality Food Brand: BakeOFun
                </p>
              </div>
              <div className="ultimate-goal-para">
                <p>
                  Our ultimate goal is to entice our customers & associates with
              ...
              <p>
                ...
                industries involving highly meticulous tasks. Because every task
                involved in crafting an edible item is constantly vulnerable to
                hazards. Taste & aroma are perceivable by senses but food safety
                is not easily traceable in a food product.
              </p>
              <p>
              ...
              <p>
                As a responsible Food Business Operator we believe that whenever
                you open a packaged food product it must be 100% safe as well as
                healthy for the whole family.
              </p>
              <p>
                We don’t use unnecessary or cheap taste enhancers or colors that
                can pose health hazards for any of the family members—young or
                seniors. We also use cautious amount of salt, sugar & additives
                in all our production recipes.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="container-fluid our-reach-main">
        <div
          ...
          style={{ backgroundColor: "#F8F3F0", paddingBottom: "30px" }}
        >
          <div className="col-5 BigBadge">
            <img src={BigBadge} alt="Big Badge" className="img-fluid" />
          </div>

          <div className="col-7" style={{ paddingRight: "30px" }}>
            ...
            <div className="our-reach-para1">
              <p>
                Our ‘BakeOFun’ products are not only delectable & tempting, but
                our brand epitomizes trust & reliance. Today ‘BakeOFun’ is
            ...
            <div className="container">
              <div className="row">
                ...
                <div className="col-9 reach-recognition" style={{marginLeft : "40px"}}>
                  <h4>REACH & RECOGNITION</h4>
                  <p>
                    We cater to more than 1500 retail outlets daily through our
                    robust dealer & distributor network across Chhattisgarh &
                    parts of Odisha. Our products are also approved and sold by
                    Modern trade giants like Dmart, Walmart, Reliance retail &
                    Big Basket.
                  </p>
                  <p>
                    Brand - ‘BakeOFun’ is approved by South Eastern Central
                    Railways (Indian Railways) for product supply at all static
                    catering units at SECR stations.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="container">
              <div className="row">
                ...
                <div className="col-9 reach-recognition" style={{marginLeft: "40px"}}>
                  <h4>RETAIL BAKERY</h4>
                  <p>
                    Our company operates two Premium Retail Bakery Outlets near
                    Mandi Gate, Pandri & Shankar Nagar Main Road, Raipur.
                  </p>
                </div>
              </div>
            </div>
